...
<html>
    <body class="antialiased">
        <div class="relative flex items-top justify-center bg-green-100 dark:bg-green-900 sm:items-center py-4 sm:pt-0">
...
<?php /**PATH C:\xampp\htdocs\Model\resources\views/auth/login.blade.php ENDPATH**/ ?>