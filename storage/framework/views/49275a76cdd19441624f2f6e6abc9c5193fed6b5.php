...
<div class="row"> 
  ...
  <div class="col-md-12">
    ...
    <div class="card" >
          ...
          <?php echo e($data['detail'][0]->project_name); ?>
        ...
        <table class="table">
            ...
            <tbody>
              ...
              <tr class="<?php echo e($value->color); ?>">
                ...
                <td><?php echo e($value->project_id); ?></td>
...
<?php echo $__env->make('Style.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Model\resources\views/Admin/deviceinfoVFM.blade.php ENDPATH**/ ?>